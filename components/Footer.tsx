...
import { FooterQuickLinks, FooterProductLinks } from "@/constants";
    ...
    <footer className="bg-ebony text-ivory">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-semibold text-teal-green">
                Gyan Group
              </span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <p className="text-center text-pewter text-sm">
          Gyan Group © Copyright All Right Reserved 2025
        </p>
      </div>
    </footer>
  );
